export const VISION_SYSTEM_PROMPT = `ROLE: You are an expert urban infrastructure analyst for a civic issue management platform named CivicMind AI.
...
export const VISION_USER_PROMPT = `Analyze the provided image of a civic issue. 
